"use client";
import { predictFertilizer } from "@/utils/fertilizer_api"; // You'll need to create this function
...
export default function FertilizerRecommendationPage() {
  ...
  const handlePrediction = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/fertilizer-detection", {
        method: "POST",
        body: formData,
      });
  ...
  const generatePDF = async () => {
    ...
    // Fertilizer Information Section
    pdf.setFont("helvetica", "normal");
    pdf.setFontSize(14);
    pdf.text("Fertilizer Information", 20, 40);
    pdf.setFontSize(12);
    pdf.text(`- Fertilizer: ${prediction.fertilizer}`, 20, 50);
    pdf.text(`- Confidence: ${prediction.confidence}%`, 20, 60);

    // Adding space after fertilizer information
    let yOffset = 70;
    ...
    imageElement.onload = () => {
      ...
      pdf.setFontSize(10);
      pdf.text("Generated by Fertilizer Recommendation System", 20, yOffset);

      // Save the PDF
      pdf.save("fertilizer_prediction_report.pdf");
    };
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-white to-green-50 relative">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/fertilizer-background.jpg')" }}
      />
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 relative z-10">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Get tailored fertilizer recommendations based on crop health and
            soil conditions. Upload a photo and get actionable insights
            instantly.
          </p>
        </div>
            ...
            {prediction ? (
              <div className="space-y-6">
                ...
                <p className="text-2xl font-bold text-green-800">
                  Recommended Fertilizer: {prediction.fertilizer}
                </p>
