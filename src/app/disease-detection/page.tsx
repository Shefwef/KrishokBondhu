...
// import { AlertCircle, ChevronRight, Leaf, Upload, X } from 'lucide-react';
// import Image from 'next/image';
// import { useRouter } from 'next/navigation';
// import React, { useEffect, useState } from 'react';
// import {prdictDisease} from '/utils/api'
...
// }
'use client';
import { predictDisease } from '@/utils/api'; // Import the API function
import { useAuth } from '@clerk/nextjs';
...
export default function DiseasePredictionPage() {
  ...
  const handlePrediction = async () => {
    ...
    setIsLoading(true);
    try {
      // Make API call to get the actual prediction
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white/80 backdrop-blur-sm shadow-xl rounded-xl p-6">
            <div
              className={`relative h-80 border-2 rounded-xl 
                ${
                  dragActive
                    ? 'border-green-500 bg-green-50'
                    : 'border-dashed border-gray-300'
