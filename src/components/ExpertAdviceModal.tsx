...
//           <p className="text-sm text-gray-500 mt-1">Posted by: {username}</p>
//         </div>

//         <div className="mb-6">
//           <h3 className="text-lg font-medium text-gray-800 mb-3">Expert Advices:</h3>
//           {advices.length > 0 ? (
//             <div className="space-y-4">
//               {advices.map((advice) => (
//                 <div key={advice._id} className="bg-gray-50 border rounded-lg p-4">
...
//             <textarea
//               className="w-full border rounded-md p-3 text-sm mb-3 focus:outline-none focus:ring focus:ring-green-300"
//               rows={3}
...
//             />
//             <button
//               className="bg-green-700 hover:bg-green-600 text-white px-5 py-2 rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-green-300"
...
//         <button
//           className="mt-6 text-sm text-gray-600 hover:text-gray-800 underline focus:outline-none"
//           onClick={onClose}
//         >
//           Close
//         </button>
